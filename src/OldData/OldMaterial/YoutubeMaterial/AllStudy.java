package OldData.OldMaterial.YoutubeMaterial;
...
/*All Prep
        ...
        Hystrix - Works on Circuit breaker design OldData.OldMaterial.pattern
        ...
        Cache aside OldData.OldMaterial.pattern

        Cache read through stratergy OldData.OldMaterial.pattern

        Cache write through strategy OldData.OldMaterial.pattern

        Cache write around strategy OldData.OldMaterial.pattern ( Writes directly to DB but read from Cache)

        Cache write back strategy OldData.OldMaterial.pattern - Bulk in Cache
...
18 : How to mock final classes
        ...
        13:- OldData.OldMaterial.Exception handling in microservices- https://www.youtube.com/watch?v=hLlGAQ5NfTE
        ...
        24 Bulk head OldData.OldMaterial.pattern: https://www.youtube.com/watch?v=R2FT5edyKOg
        ...
        28: Saga OldData.OldMaterial.pattern :https://www.youtube.com/watch?v=WnZ7IcaN_JA
        ...
        Which design OldData.OldMaterial.pattern is used in dispatcher servlet
        ...
        Circuit Breaker
        Decomposition
        1. find majority element in OldData.OldMaterial.array.
        ...
        There was one algorithmic question on saving and retrieving a binary OldData.OldMaterial.tree
        There were questions on singleton , builder design OldData.OldMaterial.pattern, collections framework in java
        Collections question map set list etc
        Find the distance between the furthest identical digrams inside String S
        Two Sum problem

        Rotate an OldData.OldMaterial.array of size n by d elements
        ...
        Search in sorted but rotated OldData.OldMaterial.array?
        ...
        How will you OldData.OldMaterial.test if multiple files with millions of words are the same or not.
