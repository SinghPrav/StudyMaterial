...
/*All Prep
        ...
        Hystrix - Works on Circuit breaker design pattern
        ...
        Cache read through stratergy pattern

        Cache write through strategy pattern

        Cache write around strategy pattern ( Writes directly to DB but read from Cache)

        Cache write back strategy pattern - Bulk in Cache
...
18 : How to mock final classes
        ...
        13:- Exception handling in microservices- https://www.youtube.com/watch?v=hLlGAQ5NfTE
        ...
        24 Bulk head pattern: https://www.youtube.com/watch?v=R2FT5edyKOg
        ...
        28: Saga pattern :https://www.youtube.com/watch?v=WnZ7IcaN_JA
        ...
        There was one algorithmic question on saving and retrieving a binary tree
        There were questions on singleton , builder design pattern, collections framework in java
        ...
        How will you test if multiple files with millions of words are the same or not.
